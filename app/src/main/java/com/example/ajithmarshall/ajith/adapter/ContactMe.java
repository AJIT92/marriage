...
public class ContactMe extends Activity {
    ...
    private void prepareListData() {
        ...
        listGrpTime.add("14/09/16 09:30am");
        listGrpTime.add("10:30am-12:00pm");
        listGrpTime.add("12:15pm");
        listGrpTime.add("12:30pm");
        // Adding child data
        List<String> Engagement = new ArrayList<String>();
        Engagement.add("A promise to wed, and also the period of time between a marriage proposal and a marriage.The duration of the courtship varies vastly, and is largely dependent on cultural norms or upon the agreement of the parties involved.");
        ...
        Reception.add("We are blessed to share our stage with family and friends and are ready to take photos and selfie's and ready to recieve your blessings whole heartedly");
